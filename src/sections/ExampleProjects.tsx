	...
	return (
		<ContainerVH50>
			<Container>
				<StyledTitle>
					<h2>
						These are some projects of mine, I would love some feedback!
						&#x1F495;
					</h2>
				</StyledTitle>
				<CardHolder>
					<FlipCard>
						...
						<a href='https://github.com/perstarkse/personal-webpage'>
							<FlipCardBody>
								<FlipCardTitle>Personal webpage</FlipCardTitle>
								<FlipCardBread>
									Page build with React, styled components and wagmi hooks. NFT
									build with ERC721 tokens, hardhat for testning and deployment.
								</FlipCardBread>
							</FlipCardBody>
						</a>
					</FlipCard>
					<FlipCard>
						...
						<a href='https://github.com/perstarkse/database-project'>
							<FlipCardBody>
								<FlipCardTitle>Python database</FlipCardTitle>
								<FlipCardBread>
									Made for registering time spent doing different tasks. Uses
									TinyDB as a database and matplotlib for presenting data
									visually.
								</FlipCardBread>
							</FlipCardBody>
						</a>
